...
<title>pipeline running on node1-upload to build -nexus-tomcat-MithunTechnologies- Home Page</title>
<link href="images/mithunlogo.jpg" rel="icon">
</head>
</head>
<body>
<h1 align="center"> Docker-scripted pipeline -Welcome to Mithun Software SOLUTIONSSSSS.</h1>
